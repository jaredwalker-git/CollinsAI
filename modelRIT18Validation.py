...
This Program Definition - Performs the validation of the deep learning the RIT18 dataset, 
the weights file generated by the model training program (ModelRIT18Training.py), 
and the custom label dataset (val_labels.mat). 
'''
