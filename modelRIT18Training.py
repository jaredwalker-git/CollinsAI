'''
Authors: Armando Vicente, Cesar Collado, Chandara Pheng, Mika Hamiti, Jared Walker
Date: UMass Lowell semesters of 2020-2021
Class: EECE.4020: Engineering Capstone Design Project
Project Title: 20-308 Collins Imaging

This Program Definition - Performs the training of the deep learning using the RIT18 dataset, and the custom label dataset.
The output file contains the weights associated with the training which is used by the model validation program (ModelRIT18Validation.PY).
'''
...
inputsX =  Input(shape = (chip_width, 40, 6), batch_size = None) 
...
#################################################################################
#Print the accuracy/loss results onto graphs
