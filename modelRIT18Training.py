...
#Band 1
inputDenseLayer1 = Lambda(lambda x: x[:, :, :], input_shape = (40, 40, 1))(inputsX)
...
#Band 2
inputDenseLayer2 = Lambda(lambda x: x[:, :, :], input_shape = (40, 40, 2))(inputsX)
...
#Band 3
inputDenseLayer3 = Lambda(lambda x: x[:, :, :], input_shape = (40, 40, 3))(inputsX)
...
#Band 4
inputDenseLayer4 = Lambda(lambda x: x[:, :, :], input_shape = (40, 40, 4))(inputsX)
...
#Band 5
inputDenseLayer5 = Lambda(lambda x: x[:, :, :], input_shape = (40, 40, 5))(inputsX)
...
#Band 6
inputDenseLayer6 = Lambda(lambda x: x[:, :, :], input_shape = (40, 40, 6))(inputsX)
