...
print("DSTL multispectral image shape: ", featuresDSTL.shape)
print("DSTL label shape: ", labelDSTL.shape)
print("Hyderabad multispectral image shape: ", featuresDSTL.shape)
